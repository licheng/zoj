...
public class StatisticsManager {
    ...
    public ProblemStatistics getProblemStatistics(long problemId) throws PersistenceCreationException,
        ...
        synchronized (problemStatisticsCache) {
            ...
            if (statistics == null) {
                statistics = PersistenceManager.getInstance().getSubmissionPersistence()
    ...
    public RankList getProblemsetRankList(long contestId, long roleId, long begin, int order)
        ...
        synchronized (ranklistCache) {
            ...
            if (ranklist == null) {
                ...
                if (roleId < 0 || ranklist.getRole() != null) {
                    List entries = PersistenceManager.getInstance().getSubmissionPersistence().getProblemsetRankList(
        ...
        synchronized (ranklistCache) {
            ...
            if (ranklist == null) {
                ...
                if (roleId < 0 || ranklist.getRole() != null) {
                    ...
                    List entries = PersistenceManager.getInstance().getSubmissionPersistence().getRankList(problmes,
    ...
    public Set getSolvedProblems(long contestId, long userId) throws PersistenceException {
        ...
        synchronized (solvedCache) {
            ...
            if (solved == null) {
                List problmes = ContestManager.getInstance().getContestProblems(contestId);
                solved = PersistenceManager.getInstance().getSubmissionPersistence()
                        .getSolvedProblems(problmes, userId);
    ...
    public List getSubmissions(SubmissionCriteria criteria, int offset, int count) throws PersistenceException {
        ...
        JudgingList judgingQueue = JudgeService.getInstance().getJudgingList();
        List submissions;
        synchronized (submissionCache) {
            submissions = (List) submissionCache.get(key);
            if (submissions == null) {
        ...
        Map<Long, Submission> submissionMap = judgingQueue.getSubmissionMap();
    ...
    public long getSubmissionsNumber(SubmissionCriteria criteria) throws PersistenceException {
        ...
        synchronized (submissionCache) {
            ...
            if (number == null) {
                number = new Long(PersistenceManager.getInstance().getSubmissionPersistence().searchSubmissionNumber(
                        criteria));
