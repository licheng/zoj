...
public class MockServer {
    public static final String[] NO_SUCH_PROBLEM = new String[] { "" + JudgeServerProxy.NO_SUCH_PROBLEM };

    public static final String[] SAVE_INTERNAL_ERROR = new String[] { "" + JudgeReply.JUDGE_INTERNAL_ERROR.getId() };

    public static final String[] SAVE_SERVER_ERROR =
	    new String[] { "" + JudgeServerProxy.READY, "" + JudgeServerProxy.SERVER_ERROR };

    public static final String[] SAVE_SUCCESS =
	    new String[] { "" + JudgeServerProxy.READY, "" + JudgeServerProxy.READY };

    public static final String[] JUDGE_INTERNAL_ERROR =
	    new String[] { "" + JudgeServerProxy.READY, "" + JudgeReply.JUDGE_INTERNAL_ERROR.getId() };

    public static final String[] COMPILATION_SERVER_ERROR = SAVE_SERVER_ERROR;

    public static final String[] COMPILATION_ERROR =
	    new String[] { "" + JudgeServerProxy.READY, "" + JudgeReply.COMPILATION_ERROR.getId(), "compilation error" };

    public static final String[] RUNNING_SERVER_ERROR =
	    new String[] {
		    "" + JudgeServerProxy.READY,
		    "" + JudgeReply.RUNNING.getId(),
		    "0 0",
		    "-1 -1",
		    "" + JudgeServerProxy.SERVER_ERROR };
    ...
    public static final String[] JUDGE_SERVER_ERROR =
	    new String[] {
		    "" + JudgeServerProxy.READY,
		    "" + JudgeReply.RUNNING,
		    "1.1 2",
		    "-1 -1",
		    "" + JudgeReply.JUDGING.getId(),
		    "" + JudgeServer.SERVER_ERROR };
    ...
    public MockServer(final boolean concurrent) throws Exception {
