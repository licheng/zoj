 ...
 * @version 2.0
 */
public class ChangePasswordActionextends BaseAction {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, ContextAdapter context) throws Exception {
		...
		PersistenceManager.getInstance().getUserPersistence().changePassword(addUserForm.getStudentNumber(), addUserForm.getPassword());
